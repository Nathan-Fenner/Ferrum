...
specialWords :: [String]
specialWords = ["var","if","while","module","class","public","private","protected","field","method","constructor","mut","alt","fin","discards","retains","modifies","alters","from","in","return","break"]
